"                  {/* Center Text inside Donut - Larger Text */}
                  <div className="absolute flex flex-col items-center justify-center text-center">
                    <span className={`text-[11px] sm:text-xs font-bold ${textDesc}`}>점주 순수익</span>
                    <span className={`text-3xl sm:text-4xl font-black ${isPink ? "text-rose-300" : "text-[#f05c40]"}`}>35%</span>
