      ...
      <header className={`sticky top-0 z-20 backdrop-blur-md transition-colors duration-300 ${headerBg}`}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 min-h-[60px] sm:min-h-[78px] flex items-center justify-between gap-2 sm:gap-4">
          <Link href={backUrl} className="flex items-center group shrink-0">
            <img src={logoUrl} alt="120pie & coffee" className="h-[22px] sm:h-[32px] w-auto object-contain group-hover:scale-[1.02] transition-transform" />
          </Link>
          <div className="flex items-center gap-1.5 sm:gap-3">
            {/* Theme switcher */}
            <div className="flex items-center rounded-full border border-neutral-350 dark:border-neutral-800 bg-neutral-900/5 dark:bg-neutral-900/60 p-0.5 text-[10px] font-black">
              <button
                type="button"
