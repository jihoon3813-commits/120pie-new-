...
const menus = [
  {
    title: "120겹 파이",
    image: "/public/images/menu-120pie.jpg",
  ...
  {
    title: "에그120",
    image: "/public/images/menu-egg120.jpg",
  ...
  {
    title: "시즌 메뉴",
    image: "/public/images/menu-season.jpg",
    ...
    <section className="section soft" id="menu">
      <div className="container">
        ...
        <article className="menu-card">
          <div className="placeholder-image menu-image">
            <span>{menu.title} 이미지</span>
            <small>{menu.image}</small>
          </div>
          <div>
            <h3>{menu.title}</h3>
