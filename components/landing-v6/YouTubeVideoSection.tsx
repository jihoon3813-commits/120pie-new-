    ...
    <section className="relative w-full h-[50vh] sm:h-[65vh] lg:h-[80vh] overflow-hidden bg-black z-0 border-none">
      ...
      <div className="absolute inset-0 w-full h-full overflow-hidden pointer-events-none select-none">
        <iframe
          ...
          src="https://www.youtube.com/embed/9tTSo_q21qk?autoplay=1&mute=1&loop=1&playlist=9tTSo_q21qk&controls=0&showinfo=0&rel=0&modestbranding=1&iv_load_policy=3&playsinline=1&enablejsapi=1"
          title="120pie Brand Background Video"
          frameBorder="0"
